...
buildings.push(
    new Building({ position: { x: 128, y: 320 } })
);
...
function enemymover() {
    ...
    if (enemies.length > 0 && enemies[0].center.y <= 1280) {
